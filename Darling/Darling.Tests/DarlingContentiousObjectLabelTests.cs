...
/// <summary>
/// #1876, Darling half: the two blocking collectors wrote <c>contentious_object</c> in two formats, and
...
/// </para>
///
/// <para>Lite.Tests' <c>ContentiousObjectLabelTests</c> pins the identical expectations, so editing one app's copy alone fails a build.</para>
/// </summary>
public sealed class DarlingContentiousObjectLabelTests
{
