...
/// <summary>
/// #1865, Lite half: a <c>blocked_process_report</c> row the object resolution could not name now says
...
///
/// <para>
/// Darling.Tests' <c>DarlingBlockedProcessReportUnresolvedReasonTests</c> pins the identical expectations against the identical shared definition, so editing one
/// app's copy alone fails a build.
/// </para>
/// </summary>
public sealed class BlockedProcessReportUnresolvedReasonTests
{
