...
public partial class LocalDataService
{
    ...
    /// long-query reader).
    /// </summary>
    public async Task<List<PlanCorrectionRow>> GetPlanCorrectionsAsync(int serverId, int hoursBack = 24, DateTime? fromDate = null, DateTime? toDate = null, IReadOnlyList<string>? databaseNames = null)
    {
