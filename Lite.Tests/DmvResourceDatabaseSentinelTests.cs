...
/// <summary>
/// #1893, Lite half: the DMV blocking snapshot's sentinel now names the database the LOCK RESOURCE
...
/// </para>
///
/// <para>Darling.Tests' <c>DarlingDmvResourceDatabaseSentinelTests</c> pins the identical expectations, so editing one app's copy alone fails a build.</para>
/// </summary>
public sealed class DmvResourceDatabaseSentinelTests
{
