...
/// Darling.Tests' copy (the ServerOverviewSort precedent: the shared pure function is tested identically in
/// each suite). The rule is: empty query matches everything; otherwise a case-insensitive substring against
/// ANY supplied field.
/// </summary>
